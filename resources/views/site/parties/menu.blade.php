...
<div id="pre-load">
   <div id="loader" class="loader">
       <div class="loader-container">
           <div class='loader-icon'><img src="{{ asset('assets/images/LOGOTYPE-15.png') }}" alt="Bizup Consulting Business"></div>
       </div>
   </div>              
</div>
    ...
    <header id="rs-header" class="rs-header style2 header-transparent">
                            ...
                            <div class="main-menu">
                                <nav class="rs-menu hidden-md">
                                    <ul class="nav-menu">
                                        ...
                                        <li><a href="#rs-project">Nos rééalisations</a> </li>
        ...
        <nav class="right_menu_togle hidden-md">
            ...
            <div class="canvas-logo">
                <a href="index.html"><img src="{{ asset('assets/images/LOGOTYPE-19.png') }}" alt="logo"></a>
            </div>
