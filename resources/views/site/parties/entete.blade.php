...
<html lang="zxx"> 
    <head>
        ...
        <link rel="shortcut icon" type="image/x-icon" href="{{ asset('assets/images/LOGOTYPE-17.png') }}">
        ...
        <!-- magnific popup css -->
        <link rel="stylesheet" type="text/css" href="{{ asset('assets/css/magnific-popup.cs') }}s">
        <!-- Main Menu css -->
